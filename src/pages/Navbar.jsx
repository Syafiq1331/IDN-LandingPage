    ...
    <div className="container mx-auto sticky inset-x-px z-50 px-8 font-montserrat">
      <div className="navbar">
        ...
        <div class="dropdown md:hidden">
          ...
          <div
            tabindex="0"
            class="dropdown-content card card-compact w-64 p-2 shadow bg-primary text-primary-content right-5 "
          >
            <div class="card-body">
              <NavLink
                to="/"
                className="tab hover:text-lime-400 text-white active:tab-bordered "
              >
                {" "}
                Home{" "}
              </NavLink>
